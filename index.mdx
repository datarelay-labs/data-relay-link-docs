...
<Note>
  **Free Early Access:** Data Relay Link is currently available free of charge under the **Data Relay Link Early Access License 1.0**. It is Source Available, not Open Source. Personal use, evaluation, internal business use, permitted internal modification, and customer-owned deployments are allowed. Early Access has no SLA and support is best effort. Commercial General Availability is planned with a **perpetual-license** model. See [License](/reference/license).
</Note>
...
## Help improve Data Relay Link

Found a problem or have an idea that would make Data Relay Link easier or safer to operate?
