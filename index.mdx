...
<Note>
  **License:** Data Relay Link is source available, not open source. Personal use, internal commercial use, internal modification, and customer-owned deployments are permitted. Productization, resale, OEM/embedding, white-labeling, competing products, and SaaS/MSP offerings require a separate written commercial license. See [License](/reference/license).
</Note>
