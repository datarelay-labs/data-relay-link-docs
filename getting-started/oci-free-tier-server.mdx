...
The high-resolution architecture diagram below shows the same deployment from the operator's point of view: one OCI Reserved Public IP fronts the FRP Auto Deploy server, while each remote client publishes one or more local or reachable LAN services through its assigned persistent public ports.

![FRP SSH access architecture using an OCI Reserved Public IP](/images/oci/53.png)
...
![Picture 5. Internet Gateway name example: frp-internet-gateway](/images/oci/5.png)
...
![Picture 20. Select the existing frp-vcn and frp-public-subnet](/images/oci/20.png)
