...
Because this guide attaches a Reserved Public IP later, turn off **Automatically assign public IPv4 address**. Then upload an existing SSH public key or let OCI generate a new key pair.

![Disable automatic public IPv4 and configure the SSH key](/images/oci/public-ip-off-ssh-key.webp)

### 3-5. Review before creating the instance

Review the image, shape, VCN/subnet, and SSH key settings before creating the instance.

![Review the OCI instance configuration](/images/oci/instance-review.webp)
