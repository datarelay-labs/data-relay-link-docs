...
description: "Prepare an Ubuntu Data Relay Link server with an OCI Always Free-eligible VM and a persistent Reserved Public IPv4 address."
...
![Data Relay Link SSH access architecture using an OCI Reserved Public IP](/images/oci/53.png)
