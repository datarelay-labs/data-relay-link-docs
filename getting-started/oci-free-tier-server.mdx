...
![OCI Compute Instance basic settings](/images/oci/compute-basic.webp)

### 3-2. Select Canonical Ubuntu 24.04

Choose **Change image**, select Canonical Ubuntu, and use the Ubuntu 24.04 LTS x86_64 image. Treat the image/version currently shown in OCI Console as authoritative.

![Select Canonical Ubuntu 24.04 in OCI](/images/oci/select-ubuntu.webp)

### 3-3. Select the VCN and public subnet

Under Primary VNIC, select the `frp-vcn` and `frp-public-subnet` created earlier.

![Select frp-vcn and the public subnet in OCI](/images/oci/select-vcn-subnet.webp)
