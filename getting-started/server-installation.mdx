...
description: "Install and verify the Data Relay Link server using the current stable release."
---

# Server Installation

The Data Relay Link server is the public entry point. It runs the bundled relay-server runtime plus enrollment, registry, lifecycle, and `drlink` management components.
...
![Data Relay Link deployment layouts: Direct, NAT, and Enterprise single-443](/images/guides/51.png)
