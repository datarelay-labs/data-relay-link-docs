...
For the simplest first deployment, use an **Ubuntu 24.04 x86_64** server with a direct public IP. Ubuntu 22.04/24.04 are the documented real-VM baseline for the stable release.
...
![FRP Auto Deploy deployment layouts: Direct, NAT, and Enterprise single-443](/images/guides/deployment-modes.webp)
...
Current published stable: **v2.2.1** with pinned FRP **v0.71.0**.
