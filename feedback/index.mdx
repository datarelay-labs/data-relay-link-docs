...
<CardGroup cols={2}>
  <Card title="Report a Bug" icon="bug" href="https://github.com/datarelay-labs/data-relay-link/issues/new?template=bug_report.yml">
    Report a reproducible product problem with version, environment, steps, expected behavior, and redacted diagnostics.
  </Card>

  <Card title="Request a Feature" icon="lightbulb" href="https://github.com/datarelay-labs/data-relay-link/issues/new?template=feature_request.yml">
...
<Warning>
  **Never post passwords, private keys, enrollment tokens, API keys, customer data, or other secrets in a public issue.** If the report may describe a security vulnerability, read the [Security Policy](https://github.com/datarelay-labs/data-relay-link/security/policy) and use a private reporting channel when available.
</Warning>
