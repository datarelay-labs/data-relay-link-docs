...
The current published stable release is **v2.2.1**. In that release, FRP Auto Deploy does **not** provide a built-in per-service source-IP allowlist policy or an application-style RBAC layer for published TCP services.
