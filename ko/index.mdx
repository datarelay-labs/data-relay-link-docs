...
| PR #14 closure 이후 Product repository `main` | `c7fe407d4dab12896469ef29cb7a882ad6311bd0` |
| Documentation/repository state | **CANONICAL / CLEAN** — PR #12 Product Master 복구 + PR #14 README/CI housekeeping merge, release/tag 변경 없음 |
| 기본 배포 | **Direct** |
...
| 플랫폼 | v2.2.1 검증 수준 |
| --- | --- |
| Ubuntu 24 physical | **Real E2E 검증 완료** |
| Rocky Linux 8.10 | **Real E2E 검증 완료** |
| Rocky Linux 9.4 | **Real E2E 검증 완료** |
| Amazon Linux 2023 | **Real E2E 검증 완료** |
| macOS Apple Silicon | **Real E2E 검증 완료** |
| Windows 10 / PowerShell 5.1 | **Real E2E 검증 완료** |
| Amazon Linux 2 | Container / CI portability만 검증 |
| PowerShell 7 | CI 검증 완료; 실제 host에 `pwsh`가 있을 때만 same-host Real E2E claim |

FRP Auto Deploy **Server는 Linux 기반**을 유지합니다. Client의 Real E2E와 container portability는 서로 다른 검증 수준이므로 구분해서 표시합니다.
