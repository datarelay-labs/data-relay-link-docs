...
Data Relay Link의 현재 stable core scope는 **TCP**입니다. 기본 published service range는 `6000-6098`입니다.

## 한눈에 보기

```mermaid
flowchart LR
    I[Internet] -->|443| S[Data Relay Link Server]
...
`TCP/22`는 Data Relay Link product path가 아니라 서버 자체 관리용 SSH일 뿐입니다.

## Enterprise single-443

| 목적 | Public TCP | 내부/backend TCP |
| --- | ---: | ---: |
| Enrollment HTTPS + Data Relay Link control over WSS | 443 | allocator 6099 + relay backend 7000 loopback |
| Published services | 6000-6098 | 6000-6098 |
...
flowchart LR
    ...
    P -->|Data Relay Link control| F[relay backend :7000 loopback]
    I -->|6000-6098| F
```
