...
FRP Auto Deploy는 **published stable release**와 변경 가능한 development `main` branch를 구분합니다.
...
FRP Auto Deploy는 upstream 최신 FRP를 자동으로 따라가지 않습니다. Project에서 특정 upstream 버전을 pin하고 검증한 뒤 qualified project release에 포함합니다.
