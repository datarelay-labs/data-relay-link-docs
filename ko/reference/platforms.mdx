...
현재 published stable은 **Data Relay Link v2.2.1**, bundled relay engine은 **v0.71.0**입니다.
...
Data Relay Link **Server는 Linux 기반**입니다. macOS와 Windows는 지원되는 Client 플랫폼이며 Windows Data Relay Link Server는 현재 제품 범위가 아닙니다.
