---
title: "서버 설치"
description: "Data Relay Link 서버를 설치하기 전에 필요한 네트워크와 설치 절차"
---

# 서버 설치

Data Relay Link 서버는 인터넷의 공인 진입점입니다. bundled relay runtime와 enrollment/registry/lifecycle/`drlink` 관리 계층이 함께 동작합니다.
...
![Data Relay Link 배포 방식: Direct, NAT, Enterprise single-443](/images/guides/deployment-modes.webp)
...
TCP/22는 서버 자체 관리 SSH용 선택 포트이며 Data Relay Link의 tunnel 경로는 아닙니다.
