...
<Warning>
  Data Relay Link는 AWS/OCI 보안 정책, 외부 방화벽/NAT, UFW/firewalld/iptables를 자동 변경하지 않습니다.
</Warning>
...
먼저 서버와 클라이언트 양쪽에서 `drlink doctor`를 실행하고 [문제 해결](/ko/operations/troubleshooting)을 따라가세요. Registry, identity, PKI, generated Data Relay Link config를 먼저 수동 수정하지 마세요.
