---
title: "업데이트"
description: "Stable project와 pinned FRP를 identity, CA, registry, port reservation을 보존하며 안전하게 업데이트합니다."
icon: "arrows-rotate"
---
...
`show upstream`은 정보용입니다. 프로젝트는 newest upstream FRP를 자동 채택하지 않고 현재 stable에서 검증된 **v0.71.0**을 pinned 상태로 유지합니다.
