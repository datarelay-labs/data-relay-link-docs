...
Data Relay Link는 **Data Relay Link tunnel authentication**과 **management-plane trust**를 분리합니다. 문제 해결이나 보안 검토에서 두 자격 증명을 혼동하지 않는 것이 중요합니다.
...
| Secret | 역할 |
| --- | --- |
| Data Relay Link server token | Data Relay Link tunnel client 인증 |
...
| Token 포함 generated Data Relay Link config | Tunnel credential 노출 가능 |
