...
Data Relay Link는 HTTP/HTTPS를 **TCP service**로 게시합니다. Published service용 application reverse proxy가 아닙니다.
...
Data Relay Link가 TLS를 종료하거나 certificate를 발급/교체하지 않습니다.
