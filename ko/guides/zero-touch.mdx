...
![기존 실사용 가이드의 Data Relay Link Client lifecycle](/images/guides/client-lifecycle.webp)
...
sequenceDiagram
    ...
    C->>S: Outbound Data Relay Link tunnel 시작
```

원격 사용자는 Data Relay Link 설정 파일을 이해할 필요가 없습니다. 서버가 출력한 정확한 명령을 한 번 실행하면 됩니다.
...
즉 OS/application provisioning이 아니라 **Data Relay Link onboarding**을 자동화합니다.
