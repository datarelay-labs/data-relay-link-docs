...
<Note>
  The full license text in the [`datarelay-labs/data-relay-link` LICENSE file](https://github.com/datarelay-labs/data-relay-link/blob/main/LICENSE) is controlling. This page is a plain-language summary and does not replace the license terms.
</Note>
