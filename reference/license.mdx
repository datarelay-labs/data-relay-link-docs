...
<Note>
  The complete legal terms are in the [Data Relay Link Early Access License 1.0](https://github.com/datarelay-labs/data-relay-link/blob/main/LICENSE). The LICENSE file is controlling; this page is a plain-language product and licensing summary.
</Note>
